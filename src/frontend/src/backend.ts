...
export class Backend implements backendInterface {
    ...
    async askQuestion(arg0: string): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.askQuestion(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async completeStudySession(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.completeStudySession(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
